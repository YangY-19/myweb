<%@ page language="C#" autoeventwireup="true" inherits="processingData, App_Web_2umeuqi2" %>
  ...
  <div class="mian">
    ...
    <div class="body" style="height:1300px">
      ...
      <div class="body-top" style="height: 959px;width: 1082px;">
        ...
        <!-- Web话题内容 -->
        <div class="introduce">
          <div class="introduce-content" style="">
            <!-- 标题 -->
            ...
            <!-- 内容 -->
            <div class="processingData-introduce">

              <asp:Repeater runat="server" ID="WT">
                  <ItemTemplate>
                      <article>
                        <a href="./particulars2.aspx?id= <%#Eval("id") %>">
                          <div class="processingData-title"><%#Eval("title") %></div>
                          ...
                          <div class="processingData-content"><%#DB.getLeftSubString(Eval("content").ToString(),250 )%></div>
                        </a>
                      </article>
                  </ItemTemplate>
              </asp:Repeater>
