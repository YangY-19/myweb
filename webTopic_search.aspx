<%@ page language="C#" autoeventwireup="true" inherits="webTopic, App_Web_nfei3cqz" %>
                  ...
                  <ItemTemplate>
                      <article class="excerpt">
                        ...
                        &nbsp;&nbsp;<header class="excerpt-title" style="text-align:left">
                          <a class="cat" href="#"><%#Eval("type").ToString().Replace(kw,"<font color='red'>"+kw+"</font>") %> <i></i></a>
                          <h2>
                        ...
                        <time class="meta">
                         ...
                         <h5 class="note"><%#DB.getLeftSubString(Eval("content").ToString().Replace(kw,"<font color='red'>"+kw+"</font>"),250 )%></h5>
                      </article>
                  </ItemTemplate>
              </asp:Repeater>
