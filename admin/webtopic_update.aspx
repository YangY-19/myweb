<%@ page language="C#" autoeventwireup="true" inherits="admin_webtopic_updateaspx, App_Web_ierhkg5z" %>
...
<body>
    <form id="form1" runat="server">
        <div class="webtopic">
            ...
            <div class="bottom">
                <asp:Button ID="Button1" runat="server" Text="提交" OnClick="tj_Click" CssClass="Button" />
            </div>
        </div>
    </form>
</body>
