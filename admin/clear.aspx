<%@ page language="C#" autoeventwireup="true" inherits="admin_clear, App_Web_ierhkg5z" %>
    ...
    <form id="form1" runat="server">
        <div class="clear">
            <div class="webtopic-icom">
                <div class="plus"><a href="clear_add.aspx"><i class="fa  fa-plus"></i> 添加</a></div>
            </div>
                    ...
                    <div class="item">
                        ...
                        <div class="item-right">
                            <div class="item-update">
                                <div class="list"><a href="clear_update.aspx?id=<%#Eval(" id") %>" target="rightFrame"><i class="fa fa-pencil-square-o"></i> 修改</a></div>
                            </div>
                            <div class="item-del">
                                <div class="trash"><a href="clear_del.aspx?id=<%#Eval(" id") %>"><i class="fa fa-trash-o"></i> 删除</a></div>
                            </div>
                        </div>
                    </div>
                </ItemTemplate>
